 ...
 * @package bikes2ride
 */
if ( ! class_exists( 'bikes2ride_Image_Grid_Widget' ) ) {

	/**
	 * Image Grid Widget
	 */
	class bikes2ride_Image_Grid_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Image Grid', 'bikes2ride' );
			$this->widget_description = esc_html__( 'This widget displays images from post.', 'bikes2ride' );
			...
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
					'value' => 'Image Grid',
					'label' => esc_html__( 'Widget title', 'bikes2ride' ),
				),
				'terms_type' => array(
					'type'    => 'radio',
					'value'   => 'category_name',
				...
				'category_name' => array(
					...
					'label'            => esc_html__( 'Select categories to show', 'bikes2ride' ),
				...
				'tag' => array(
					...
					'label'            => esc_html__( 'Select tags to show', 'bikes2ride' ),
				...
				'post_sort' => array(
					...
					'value'   => 'date',
					'options' => array(
						'date'          => esc_html__( 'Publish Date', 'bikes2ride' ),
						'title'         => esc_html__( 'Post Title', 'bikes2ride' ),
						'comment_count' => esc_html__( 'Comment Count', 'bikes2ride' ),
					),
					'label'   => esc_html__( 'Post sorted', 'bikes2ride' ),
				),
				'post_number' => array(
					'type'       => 'stepper',
					'value'      => '5',
					...
					'min_value'  => '1',
					'step_value' => '1',
					'label'      => esc_html__( 'Posts number', 'bikes2ride' ),
				),
				'post_offset' => array(
					'type'       => 'stepper',
					'value'      => '0',
				...
				'columns_number' => array(
					...
					'min_value'  => '1',
					'step_value' => '1',
					'label'      => esc_html__( 'Columns number', 'bikes2ride' ),
				),
				'items_padding' => array(
					'type'       => 'stepper',
					'value'      => '5',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Items padding ( size in pixels )', 'bikes2ride' ),
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			$args = apply_filters( 'bikes2ride_image_grid_widget_args', $args, $instance );
			...
			if ( array_key_exists( $terms_type, $instance ) ) {
				...
				if ( $post_taxonomy ) {
					$post_args = array(
						...
						'order'       => apply_filters( 'bikes2ride_order_image_grid_widget', 'DESC', $instance ), // ASC
			...
			if ( isset( $posts ) && $posts ) {
				...
				$grid_class_array = apply_filters( 'bikes2ride_image_grid_widget_grid_class', array(
				...
				echo apply_filters(
					'bikes2ride_image_grid_widget_before',
				...
				echo apply_filters( 'bikes2ride_image_grid_widget_after', '</div>', $instance );
			}
	...
	add_action( 'widgets_init', 'bikes2ride_register_image_grid_widget' );
	/**
	 * Register image grid widget.
	 */
	function bikes2ride_register_image_grid_widget() {
		register_widget( 'bikes2ride_Image_Grid_Widget' );
	}
}
