...
add_action( 'cherry_data_import_home_regex_replace', 'bikes2ride_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'bikes2ride_remap_menus' );
 ...
 * @return array
 */
function bikes2ride_remap_shortcodes( $regex ) {
 ...
 */
function bikes2ride_remap_menus( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function bikes2ride_remap_timetable( $posts ) {
