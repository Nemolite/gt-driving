 ...
 */
add_filter( 'template_include', array( 'Bikes2Ride_Wrapping', 'wrap' ), 99 );
add_filter( 'bikes2ride_wrap_base', 'bikes2ride_wrap_base_cpts' );
 ...
 */
function bikes2ride_template_path() {
	return bikes2ride_Wrapping::$main_template;
}
 ...
 */
function bikes2ride_template_base() {
	return bikes2ride_Wrapping::$base;
}

if ( ! class_exists( 'Bikes2Ride_Wrapping' ) ) {
	...
	class Bikes2Ride_Wrapping {
		...
		/**
		 * Initialize new instance of bikes2ride_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'bikes2ride_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in bikes2ride_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new bikes2ride_Wrapping();
		}
	}
}
 ...
 */
function bikes2ride_wrap_base_cpts( $templates ) {
