...
if ( ! class_exists( 'Bikes2Ride_Widget_Area' ) ) {

	/**
	 * class Bikes2Ride_Widget_Area.
	 */
	class Bikes2Ride_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'bikes2ride_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'bikes2ride_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'bikes2ride_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function bikes2ride_widget_area() {
		return bikes2ride_Widget_Area::get_instance();
	}

	bikes2ride_widget_area();
}
